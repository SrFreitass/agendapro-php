...
<body>
    <form class="min-h-screen flex flex-col items-start justify-center gap-4 max-w-[30rem] m-auto" action="../../routes/route.php?controller=signup" method="post">
        ...
        <a href="/signin" class="!text-black">Ainda não tem uma conta? <u> Criar aqui </u></a>
    </form>
</body>
</html>