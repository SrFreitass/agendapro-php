...
export const Header = () => {
    return (
        <header className="p-6 flex items-center justify-between sticky top-0 z-10 bg-white drop-shadow">
            ...
            <h2 className="font-semibold text-xl text-blue-950">Agenda Pro</h2>
            </div>
