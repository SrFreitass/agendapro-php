        ...
        <Dialog>
            ...
            <DialogContent className="py-16">
                <DialogHeader className="items-center">
                    ...
                    <DialogDescription>
                        Ao criar a conta você poderar fazer reservas
                    </DialogDescription>
                </DialogHeader>
                <form className="flex flex-col gap-4">
                    ...
                    <Button className="bg-[#ff5a5f]">Criar conta</Button>
                    <Link className="text-zinc-600 font-medium" to={""}>Já tem uma conta? Entrar</Link>
                </form>
            </DialogContent>
        </Dialog>
    )
