import { Heart, HomeIcon, Users } from "lucide-react"
...
export const Place = () => {
    return (
        <motion.div initial={{ y: -35, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="flex flex-col gap-2 relative">
            <img className="w-[25rem] h-[22rem] rounded-xl" src="https://www.aarquiteta.com.br/blog/wp-content/uploads/2022/01/como-construir-uma-piscina-residencial-2.jpg"/>
